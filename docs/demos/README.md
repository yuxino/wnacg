# wnacg interface demonstration

The animated preview and MP4 show interactions with the actual production frontend at `062e0a39c70cc7b37872863ae34e9ba538e2a0e2`. The recording uses original sample documents and documentation-only substitutes for native API boundaries, not a native macOS/Windows session.

**Scope:** Reading UI · original local pages · no upstream content or AI.
...
<!-- demo-pacing -->
Playback is paced at **2×** the original recording (33.76s → 16.88s). The MP4 and animated preview have matching timing; all scenes, captions and sample-data disclosures are retained.
<!-- /demo-pacing -->
